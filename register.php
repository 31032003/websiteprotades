...
<body class="d-flex align-items-center min-h-100">
  ...
  <header id="header" class="navbar navbar-expand navbar-light navbar-absolute-top">
    <div class="container-fluid">
      <nav class="navbar-nav-wrap">
        <!-- White Logo -->
        <a class="navbar-brand d-none d-lg-flex" href="index.php" aria-label="Front">
          <img class="navbar-brand-logo" src="src/assets/svg/logos/logo-white.svg" alt="Logo">
        </a>
        <!-- End White Logo -->

        <!-- Default Logo -->
        <a class="navbar-brand d-flex d-lg-none" href="index.php" aria-label="Front">
          <img class="navbar-brand-logo" src="src/assets/svg/logos/logo.svg" alt="Logo">
        </a>
        <!-- End Default Logo -->
        ...
        <div class="col-lg-5 col-xl-4 d-none d-lg-flex justify-content-center align-items-center min-vh-lg-100 position-relative bg-dark" style="background-image: url(./assets/svg/components/wave-pattern-light.svg);">
          <div class="flex-grow-1 p-5">
            ...
            <figure class="text-center">
              <div class="mb-4">
                <img class="avatar avatar-xl avatar-4x3" src="src/assets/svg/brands/mailchimp-white.svg" alt="Logo">
              </div>
              ...
              <figcaption class="blockquote-footer blockquote-light">
                <div class="mb-3">
                  <img class="avatar avatar-circle" src="src/assets/img/160x160/img9.jpg" alt="Image Description">
                </div>
            ...
            <div class="position-absolute start-0 end-0 bottom-0 text-center p-5">
              <div class="row justify-content-center">
                <div class="col text-center py-3">
                  <img class="avatar avatar-lg avatar-4x3" src="src/assets/svg/brands/fitbit-white.svg" alt="Logo">
                </div>
                <!-- End Col -->

                <div class="col text-center py-3">
                  <img class="avatar avatar-lg avatar-4x3" src="src/assets/svg/brands/business-insider-white.svg" alt="Logo">
                </div>
                <!-- End Col -->

                <div class="col text-center py-3">
                  <img class="avatar avatar-lg avatar-4x3" src="src/assets/svg/brands/capsule-white.svg" alt="Logo">
                </div>
                <!-- End Col -->
              </div>
              <!-- End Row -->
        ...
        <div class="col-lg-7 col-xl-8 d-flex justify-content-center align-items-center min-vh-lg-100">
          <div class="flex-grow-1 mx-auto" style="max-width: 28rem;">
            ...
            <div class="text-center mb-5 mb-md-7">
              <h1 class="h2">Daftarkan diri anda</h1>
              <p>Untuk bergabung sebagai pejuang arsip.</p>
            </div>
            <!-- End Heading -->
            ...
            <form class="js-validate needs-validation" novalidate>
              <!-- Form -->
              <div class="mb-4">
                <label class="form-label" for="signupModalFormLoginEmail">Nama</label>
                <input type="text" class="form-control form-control-lg" name="email" id="signupModalFormLoginEmail" placeholder="nama anda" aria-label="email@site.com" required>
                <span class="invalid-feedback">Masukan nama lengkap anda.</span>
              </div>
              <!-- End Form -->
                 <!-- Form -->
                 <div class="mb-4">
  ...
  <!-- JS Front -->
  <script src="dists/assets/js/theme.min.js"></script>
